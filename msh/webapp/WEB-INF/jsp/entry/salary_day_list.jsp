...
<div class="row">
    <div class="col-xs-12">
        <form id="search_form" class="form-inline" action="/entry/statistics/salaryForDay" method="post" role="form">
            统计结账日期范围：
            ...
            <button class="btn btn-white btn-default btn-round" type="button" onclick="forward('/entry/statistics/salaryForMonth')">
            ...
            <div class="col-xs-12">
                <div>
                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <th><i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>日期</th>
                                <th>结账金额</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr>
                            ...
                            <td>${entrySalaryDTO.sumSalary}</td>
                        </tr>
                        </tbody>
                    </table>
